    ...
    <div className="text-white body-font bg-zinc-400">
        <div className="container px-5 py-8 mx-auto flex items-center flex-row">
            ...
            <span className="inline-flex ml-auto justify-center flex-wrap">
                <a href="https://github.com/shshjhjh4455/character_chatbot_web" className="text-gray-600" target="_blank">
                    <svg fill="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-5 h-5" viewBox="0 0 16 16">
